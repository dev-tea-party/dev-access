<div class="form-group {{ $errors->has('mat_item_code') ? 'has-error' : ''}}">
    {!! Form::label('mat_item_code', 'Item Code', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('mat_item_qty', 'Qty', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('jo_id', 'JO Code', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
