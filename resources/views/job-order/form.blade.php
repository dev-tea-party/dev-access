<div class="form-group {{ $errors->has('jo_code') ? 'has-error' : ''}}">
    ...
    {!! Form::label('jo_desc', 'Jo Desc', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('jo_cost', 'Jo Cost', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('prj_id', 'Prj Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
