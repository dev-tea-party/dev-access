        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Joborder</div>
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Jo Code</th><th>Jo Desc</th><th>Jo Cost</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($joborder as $item)
                                    <tr>
                                        <td>{{ $item->jo_id }}</td>
                                        <td>{{ $item->jo_code }}</td><td>{{ $item->jo_desc }}</td><td>{{ $item->jo_cost }}</td>
                                        <td>
