<div class="form-group {{ $errors->has('sup_name') ? 'has-error' : ''}}">
    {!! Form::label('sup_name', 'Sup Name', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_cat_id', 'Sup Cat Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::select('sup_cat_id', ['1', '2', '3'], null, ['class' => 'form-control']) !!}
        {!! $errors->first('sup_cat_id', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('sup_vat_num') ? 'has-error' : ''}}">
    {!! Form::label('sup_vat_num', 'Sup Vat Num', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_op_bal', 'Sup Op Bal', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_addr_1', 'Sup Addr 1', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_addr_2', 'Sup Addr 2', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_contact_name', 'Sup Contact Name', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_contact_email', 'Sup Contact Email', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_tel_num', 'Sup Tel Num', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_mobile_num', 'Sup Mobile Num', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_fax_num', 'Sup Fax Num', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_website', 'Sup Website', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_bank_acct_holder', 'Sup Bank Acct Holder', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_bank_acct_num', 'Sup Bank Acct Num', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_bank_acct_type', 'Sup Bank Acct Type', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_bank_name', 'Sup Bank Name', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('sup_bank_code', 'Sup Bank Code', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
