            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/suppliers/supplier-category', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($suppliercategory as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/suppliers/supplier-category', $item->sup_cat_id],
                            ...
                            <div class="pagination-wrapper"> {!! $suppliercategory->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
