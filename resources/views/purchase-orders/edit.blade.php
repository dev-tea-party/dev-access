        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit PO #{{ $purchaseorder->po_num }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::model($purchaseorder, [
                            'method' => 'PATCH',
                            'url' => ['/purchasing/purchase-orders', $purchaseorder->po_id],
                            'class' => 'form-horizontal',
                            'files' => true
                        ]) !!}

                        @include ('purchase-orders.form', ['submitButtonText' => 'Update'])
